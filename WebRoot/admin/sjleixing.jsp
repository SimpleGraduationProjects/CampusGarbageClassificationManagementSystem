...
<!--startprint-->
	 ...
	 pagination="true" url="../getSjleixings" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjleixingMark1" width="40">说明</th>
				<th field="sjleixingDouble" width="20">积分</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>
		&nbsp;名称：&nbsp;<input type="text" name="s_sjleixingName" id="s_sjleixingName" size="10"/>
		<a href="javascript:searchSjleixing()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
		</div>
	</div>
<!--endprint-->
	<div id="dlg" class="easyui-dialog" style="width: 540px;height: 160px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>说明：</td>
					<td><input type="text" name="sjleixingMark1" id="sjleixingMark1" class="easyui-validatebox" required="true"/></td>
					<td>积分：</td>
					<td><input type="text" name="sjleixingDouble" id="sjleixingDouble" class="easyui-validatebox" required="true"/></td>
				</tr>
			</table>
		</form>
	</div>
