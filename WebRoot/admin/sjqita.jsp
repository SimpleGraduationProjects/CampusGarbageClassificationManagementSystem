...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getSjqitaBieming()%>信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjqitas" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjqitaType" width="10" formatter="formatType">状态</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:openSjqitaAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
			...
			<a href="javascript:shangchuanSjqita()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传缩略图</a>
			<a href="javascript:shangjiaSjqita()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">上架</a>
			<a href="javascript:xiajiaSjqita()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">下架</a>
		</div>
	</div>
<!--endprint-->
