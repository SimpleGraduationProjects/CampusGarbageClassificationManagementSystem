...
var url;
	...
	function openSjxingtaiAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加倡导类型");
		url="../addSjxingtai";
	}
	...
	function openSjxingtaiModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑倡导类型");
		$("#fm").form("load",row);
	...
	function daoruSjxingtais(){
		$("#daoru").dialog("open").dialog("setTitle","导入倡导类型");
	...
	function shangchuanSjxingtai(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传倡导类型");
...
<!--startprint-->
	<table id="dg" title="倡导类型" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjxingtais" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
