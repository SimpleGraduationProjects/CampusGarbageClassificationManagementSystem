...
var url;
	...
	function chakanNeirong(shujuId, row) {
		return '<a style="color:red;"target="_blank" href="<%=basePath%>wangzhan/shujuneirong.jsp?shujuId=' + shujuId + '">查看' + '</a>';  
	}
</script>
</head>
...
<!--startprint-->
	 ...
	 pagination="true" url="../getShujus" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="shujuMark1" width="40">备注</th>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:shangjiaShuju()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">上架</a>
