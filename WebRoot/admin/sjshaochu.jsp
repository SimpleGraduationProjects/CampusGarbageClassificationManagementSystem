...
var url;
	...
	function openSjshaochuAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加购买垃圾袋");
		url="../addSjshaochu";
	}
	...
	function openSjshaochuModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑购买垃圾袋");
		$("#fm").form("load",row);
	...
	function daoruSjshaochus(){
		$("#daoru").dialog("open").dialog("setTitle","导入购买垃圾袋");
	...
	function shangchuanSjshaochu(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传购买垃圾袋");
...
<!--startprint-->
	<table id="dg" title="购买垃圾袋" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjshaochus" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjshaochuZong1" width="10">剩余</th>
	...
	<div id="dlg" class="easyui-dialog" style="width: 540px;height: 360px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>备注3：</td>
					<td><input type="text" name="sjshaochuMark3" id="sjshaochuMark3" class="easyui-validatebox" required="true"/></td>
				...
				<tr>
					<td>总数：</td>
					<td><input type="text" name="sjshaochuZong" id="sjshaochuZong" class="easyui-validatebox" required="true"/></td>
					<td>单价：</td>
					<td><input type="text" name="sjshaochuDouble" id="sjshaochuDouble" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td><%=newJcpeizhi.getSjqitaBieming()%>：</td>
					<td><input class="easyui-combobox" id="sjqitaId" name="sjqitaId"  data-options="panelHeight:'auto',editable:false,valueField:'sjqitaId',textField:'sjqitaName',url:'../sjqitaComboList'"/></td>
					<td><%=newJcpeizhi.getSjlaiyuanBieming()%>：</td>
					<td><input class="easyui-combobox" id="sjlaiyuanId" name="sjlaiyuanId"  data-options="panelHeight:'auto',editable:false,valueField:'sjlaiyuanId',textField:'sjlaiyuanName',url:'../sjlaiyuanComboList'"/></td>
				</tr>
				<tr>
