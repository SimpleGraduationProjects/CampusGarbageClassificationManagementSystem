	 ...
	 pagination="true" url="../getUsers?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="userMark" width="20">班级</th>
				<th field="userDouble" width="10">积分</th>
	...
	<div id="dlg" class="easyui-dialog" style="width: 540px;height: 160px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>
					<td>班级：</td>
					<td><input type="text" name="userMark" id="userMark" class="easyui-validatebox" required="true"/></td>
					<td>年龄：</td>
