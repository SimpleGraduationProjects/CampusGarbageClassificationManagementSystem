...
var userId = <%=userId%>;
	...
	function openSjshaochuModifyDialog(){
		...
		if(row.sjshaochuZong1==0){
			$.messager.alert("系统提示","可用垃圾袋不足，请选择其他！");
			return;
		}
		$("#dlg").dialog("open").dialog("setTitle","编辑购买垃圾袋");
		$("#fm").form("load",row);
		url="../addSjpinglun?sjpinglunType1="+row.sjshaochuId+"&userId="+row.userId+"&shujuId="+row.shujuId;
	}
...
<!--startprint-->
	...
	<div id="tb">
		<div>
			<a href="javascript:openSjshaochuModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">装袋投放</a>
		</div>
		<div>
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					...
					<td><input class="easyui-combobox" id="roleId" name="roleId"  data-options="panelHeight:'auto',editable:false,valueField:'sjlaiyuanId',textField:'sjlaiyuanName',url:'../sjlaiyuanComboList?sjlaiyuanType=0'"/></td>
				</tr>
			</table>
		</form>
	</div>
