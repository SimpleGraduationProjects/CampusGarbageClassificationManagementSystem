...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getUserBieming()%><%=newJcpeizhi.getUxinxiBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getUxinxis?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:openUxinxiAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
			<a href="javascript:openUxinxiModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
			<a href="javascript:deleteUxinxi()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
		</div>
	</div>
<!--endprint-->
	
	<div id="dlg" class="easyui-dialog" style="width: 520px;height: 240px;padding: 10px 20px"
