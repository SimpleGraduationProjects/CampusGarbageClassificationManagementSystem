...
var url;
	...
	function openSjpinglunAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加分类扔垃圾");
		url="../addSjpinglun";
	}
	...
	function openSjpinglunModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑分类扔垃圾");
		$("#fm").form("load",row);
	...
	function daoruSjpingluns(){
		$("#daoru").dialog("open").dialog("setTitle","导入分类扔垃圾");
	...
	function shangchuanSjpinglun(){
		...
		var row=selectedRows[0];
		$("#shangchuan").dialog("open").dialog("setTitle","上传分类扔垃圾");
...
<!--startprint-->
	<table id="dg" title="分类扔垃圾" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjpingluns?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjpinglunName" width="40">垃圾</th>
				<th field="sjpinglunMark" width="40">备注</th>
				<th field="sjpinglunType" width="10">积分</th>
				<th field="roleId" width="20" hidden="true"><%=newJcpeizhi.getSjlaiyuanBieming()%>ID</th>
				<th field="roleName" width="20"><%=newJcpeizhi.getSjlaiyuanBieming()%></th>
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>
					...
					<td>备注：</td>
					<td><input type="text" name="sjpinglunMark" id="sjpinglunMark" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>备注1：</td>
					<td><input type="text" name="sjpinglunMark1" id="sjpinglunMark1" class="easyui-validatebox" required="true"/></td>
					<td>备注2：</td>
					<td><input type="text" name="sjpinglunMark2" id="sjpinglunMark2" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>总数：</td>
					<td><input type="text" name="sjpinglunZong" id="sjpinglunZong" class="easyui-validatebox" required="true"/></td>
					<td>单价：</td>
					<td><input type="text" name="sjpinglunDouble" id="sjpinglunDouble" class="easyui-validatebox" required="true"/></td>
				</tr>
		</form>
	</div>
