      ...
      <tr>
        ...
        <td height="" valign="top" bgcolor="#FFFFFF" style="border:1px solid #e0e0e0; padding:10px; line-height:25px;">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" class="line"><%=sousuoShuju.getShujuName()%></td>
                  </tr>
                  <tr>
                    <td height="30" align="center" class="line"><%=DateUtil.formatDate(sousuoShuju.getShujuDate(),"yyyy-MM-dd HH:mm:ss") %> 发布者:管理员</td>
                  </tr>
                  <tr>
                    <td align="left"><div style="margin:20px; line-height:23px;"><%=sousuoShuju.getShujuMark()%></div></td>
                  </tr>
			</table>
        </td>
		<%}else{ %>
		<td>没有选择<%=newJcpeizhi.getShujuBieming() %></td>
		<%} %>
      </tr>
    </table></td>
  </tr>
