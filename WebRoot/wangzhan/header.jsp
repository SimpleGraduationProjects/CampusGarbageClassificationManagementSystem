            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<%=basePath %>wangzhan/sjduochulist.jsp"><%=newJcpeizhi.getSjduochuBieming() %></a></li>
                        <li><a href="<%=basePath %>wangzhan/shujulist.jsp"><%=newJcpeizhi.getShujuBieming() %>信息</a></li>
                        <li><a href="<%=basePath %>wangzhan/sjqitalist.jsp"><%=newJcpeizhi.getSjqitaBieming() %>信息</a></li>
